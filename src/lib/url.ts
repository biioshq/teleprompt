 ...
 * build and run time, and — importantly — it is the *production* domain even on
 * a preview deployment. That is exactly what canonical links, Open Graph tags
 * and the sitemap want: a preview should not advertise itself as the real site.
 *
